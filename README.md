...
| `docs/` | [`GLOSSARY.md`](docs/GLOSSARY.md) (plain-language definitions of terms used in code comments) plus internal engineering audits. | The glossary helps if you're reading the code; the audits are background only. |
| `mockups/` | Throwaway HTML design sketches used while exploring the UI. **Not** part of the shipped app. | No — safe to ignore. |
