...
import type { Edge, ComputedValues, SolverMeta } from "./types";
import {
...
export function recomputeValues(): void {
  ...
  const meta: SolverMeta = (values as ComputedValues & { __meta?: SolverMeta }).__meta || { converged: true, iterations: 0 };
