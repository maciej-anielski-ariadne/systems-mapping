...
| File | What it's for |
|------|---------------|
| [`pathway-atlas.html`](PATHWAY-ATLAS.md) | Everything downstream of **one** box, as a single picture you can zoom into. Enumerates nothing, so there is no cap and no wait. |
